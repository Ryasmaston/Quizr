                    ...
                    <div className="p-6">
                      ...
                      <div className="grid gap-2 sm:grid-cols-2">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            window.location.href = `/quiz/${quiz._id}/edit`;
                          }}
                        ...
                        <button
                          ...
                          className="w-full px-4 py-2.5 bg-rose-500/20 border border-rose-400/50 rounded-xl text-rose-200 text-sm font-semibold hover:bg-rose-500/30 transition-all flex items-center justify-center gap-2"
                        >
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
